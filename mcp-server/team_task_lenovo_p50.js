...
async function createLenovoKeyboard() {
    try {
        console.log("Team is processing: Lenovo ThinkPad P50 Keyboard...");

        // 1. Research Data (P50/P51/P70/P71 Series)
...
هذه الكيبورد لا تتوافق مع موديلات P50s أو P70s، يرجى مطابقة شكل الكيبورد والـ FRU Number قبل الطلب.
</blockquote>
...
<strong>خدمة التركيب الاحترافية:</strong> متوفرة في مركز فيكس زون مصر لضمان تركيب آمن لجهازك والحفاظ على سلامة الـ Chassis.
        ...
        const productData = {
            ...
            categories: [{ id: 69 }], // Keyboard category ID
            tags: [
                { name: "Lenovo" },
                { name: "ThinkPad" },
                { name: "P50" },
